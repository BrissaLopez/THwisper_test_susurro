...
class Algoritmo{
    ...
    public function iniciarTest(){
        ...
        for($ciclo = 0; $ciclo <=2; $ciclo++){
            ...
            if($ciclo == 2){ //si ciclo == 2, se hace el oído izquierdo
                ...
                echo "<br>      Se ha escogido: ".$grupoString;
    ...
    public function ladoDerecho($grupoEscogido){
        
        switch ($grupoEscogido){
            
            case "grupo1":
                //var_export($this->grupo_uno_derecha);
                $palabrasSeleccionadas = array_rand($this->grupo_uno, 10);
                
                $this->seleccionaPalabra($palabrasSeleccionadas);
                
            case "grupo2":
                $palabrasSeleccionadas = array_rand($this->grupo_dos);
                $this->seleccionaPalabra($arrayPalabrasSeleccionadas);
                    
    
                
                
            default:
                echo " aun no se ha creado el grupo.";
